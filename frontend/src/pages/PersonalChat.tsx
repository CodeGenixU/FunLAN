...
const PersonalChat = () => {
    // In a real app, we would get the user ID from the URL params
    // const { id } = useParams();
                ...
                <div className="flex gap-3 max-w-[80%]">
                    ...
                    <div className="space-y-1">
                        <div className="p-3 bg-card/50 backdrop-blur-sm border border-white/5 rounded-2xl rounded-tl-none text-sm shadow-sm">
                            <p>Hi! Are we still meeting later?</p>
                        </div>
                ...
                <div className="flex gap-3 max-w-[80%] ml-auto flex-row-reverse">
                    ...
                    <div className="space-y-1">
                        <div className="p-3 bg-primary text-primary-foreground rounded-2xl rounded-tr-none text-sm shadow-sm">
                            <p>Yes, definitely! See you then.</p>
                        </div>
                        <span className="text-xs text-muted-foreground text-right block">10:32 AM</span>
                    </div>
                </div>
            </div>
